 ...
 * is forward
 *
 *  Note: Rewritten for sake of Squarespace codeSample, 
 *           Should be noted that this takes an entity system based approach for a 2.5D non-physical camera
 *
 *  Note: dislike the use of bounds class limit use and eliminate in later iterations bounds is too dependent
 * 
